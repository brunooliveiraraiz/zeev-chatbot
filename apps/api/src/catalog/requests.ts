...
export const REQUESTS_CATALOG: ZeevRequestCatalogItem[] = [
  ...
  // ==================== COMERCIAL ====================
  {
    ...
    examples: [
      ...
      'personalizar forma de pagamento do cliente',
      'criar novo serviço comercial',
      'plano especial para aluno',
      'montar plano de pagamento customizado',
      'quero criar um plano de pagamento',
      'preciso criar plano de pagamento'
    ],
  ...
  },
  {
    ...
    tags: ['financeiro', 'pagamento', 'reembolso', 'fundo fixo', 'adiantamento', 'nota fiscal', 'boleto', 'solicitacao financeira', 'demanda financeira', 'despesa', 'pagar', 'financas', 'abrir solicitacao de pagamento', 'quero abrir solicitacao', 'abrir pagamento'],
    examples: [
      'solicitar pagamento',
      'solicitação financeira',
      'abrir solicitação financeira',
      'quero abrir solicitacao de pagamento',
