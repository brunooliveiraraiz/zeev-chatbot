...
(function() {
  ...
  function init() {
    ...
    // Verificar se está em página de login ou autenticação
    const currentPath = window.location.pathname;
    const isLoginPage = currentPath.includes('/login') || currentPath.includes('/auth');

    // Não inicializar em páginas de formulário, dentro de iframes ou em páginas de login
    if (isFormPage || isInIframe || isLoginPage) {
      console.log('⏭️ Zeev Chatbot: Não inicializando em formulário, iframe ou login');
      return;
    }
